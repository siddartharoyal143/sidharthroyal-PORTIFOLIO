    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <section ref={heroRef} className="min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center z-10 relative">
          ...
          >
            <motion.div variants={itemVariants}>
              <h1 className="text-6xl md:text-8xl font-bold mb-6">
                <span className="gradient-text block">M SIDDHARTHA</span>
                <span className="gradient-text block">ROYAL</span>
              </h1>
            </motion.div>
          ...
          >
            {[
              { icon: Mail, text: "siddhartha@example.com", variant: "default" as const },
              { icon: Phone, text: "+91 98765 43210", variant: "outline" as const },
              { icon: MapPin, text: "Hyderabad, India", variant: "outline" as const }
            ].map(({ icon: Icon, text, variant }, index) => (
              <motion.div key={text} variants={itemVariants}>
                <Button 
                  variant={variant} 
                  className={variant === "default" ? "gradient-bg hover-lift group" : "glass-button hover-lift group"}
                >
          ...
          >
            {[
              { icon: Github, color: "glow-primary" },
              { icon: Linkedin, color: "glow-secondary" },
              { icon: Twitter, color: "glow-accent" }
            ].map(({ icon: Icon, color }, index) => (
              <motion.div key={index} variants={itemVariants}>
                <motion.button
                  className={`glass-button hover-lift ${color} p-3 rounded-full border border-white/20`}
                  whileHover={{ scale: 1.1 }}
                  whileTap={{ scale: 0.9 }}
                  key={index}
                >
